...
// Public: Used to remove a SWFUpload instance from the pages. This method strives to remove
...
SWFUpload.prototype.destroy = function () {
	try {
		...
		if (movieElement && typeof(movieElement.CallFunction) === "unknown") { // We only want to do this in IE
			...
			// Remove the Movie Element from the pages
			try {
...
SWFUpload.prototype.cleanUp = function (movieElement) {
	...
	// Fix Flashes own cleanup code so if the SWFMovie was removed from the pages
...
/* **********************************
	Debug Console
	The debug console is a self contained, in pages location
