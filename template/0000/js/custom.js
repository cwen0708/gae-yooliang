...
jQuery(document).ready(function($) {
	...
	/*	Custom Functions
	/* ---------------------------------------------------------------------- */
    var nav_current = $("#main-nav").data("current");
    if (nav_current != "")
    {
        $("#main-nav li a").each(function(){
            if ($(this).attr("href").indexOf(nav_current) >= 0){
                $(this).parent().addClass("current");
            }
        });
        if (nav_current == "contact.html") {
	...
	(function() {
		...
		var $mainNav    = $('#main-nav').children('ul'),
			optionsList = '<option value="" selected>選單...</option>';
