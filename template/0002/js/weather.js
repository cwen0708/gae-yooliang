    ...
    $(".weather").each(function () {
        ...
        $.simpleWeather({
            ...
            success: function (weather) {
                var html = '<h2 style="margin: 3px;">' + weather.city + '' + weather.region + '</h2>';
                html += '<img style="float:left; margin:6px;" width="64px" src="'+weather.image+'">' + weather.temp + '&deg;' + weather.units.temp + '<br />';
                html += '' + weather.currently + '<br />';
                html += '<a target="_blank" href="' + weather.link + '">查看天氣預報</a><br />';
